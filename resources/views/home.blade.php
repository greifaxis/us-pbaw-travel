...
@section('content')
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-5" data-ride="carousel">
            ...
            <div class="carousel-inner rounded" role="listbox">
                ...
                <div class="carousel-item active " style="background-image: url('https://source.unsplash.com/jr3ZPsaQwQo/1920x1080')">
...
{{--                <div class="carousel-item" style="background-image: url('https://source.unsplash.com/bF2vsubyHcQ/1920x1080')">--}}
                <div class="carousel-item" style="background-image: url('https://source.unsplash.com/VR8y40jx8II/1920x1080')">
                    <div class="carousel-caption d-none d-md-block">
...
{{--                <div class="carousel-item" style="background-image: url('https://source.unsplash.com/szFUQoyvrxM/1920x1080')">--}}
                <div class="carousel-item" style="background-image: url('https://source.unsplash.com/xoxO2Q91UN0/1920x1080')">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="row align-items-center my-5">
        <div class="col-lg-7">
            <img class="img-fluid rounded mb-4 mb-lg-0" src="https://source.unsplash.com/S4p__T-WPYY/900x400" alt="Globe">
        </div>
        <!-- /.col-lg-8 -->
        <div class="col-lg-5">
    ...
    <div class="row align-items-center my-5">
        ...
        <!-- /.col-md-4 -->
        <div class="col-lg-7">
            <img class="img-fluid rounded mb-4 mb-lg-0" src="https://source.unsplash.com/s87bBFZviAU/900x400" alt="Globe">
        </div>
    </div>
    <!-- /.row -->
