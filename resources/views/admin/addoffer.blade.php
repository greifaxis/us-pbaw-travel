            ...
            <div class="card my-4 mx-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mx-1">
                        ...
                        {{Form::text('price','',['class'=>'form-control col-sm-9','placeholder'=>'Price'])}}
                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('sale','Sale',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('sale','',['class'=>'form-control col-sm-9','placeholder'=>'Sale'])}}
                    </div>
                    <div class="form-group row mx-1">
                    ...
                    <div class="form-group row mx-1">
                        ...
                        {{Form::text('highlight','',['class'=>'form-control col-sm-9','placeholder'=>'Highlight'])}}
                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('body','Body',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::textarea('body','',['class'=>'form-control col-sm-9','placeholder'=>'Body'])}}
                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('places_max','Places Max',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('places_max','',['class'=>'form-control col-sm-9','placeholder'=>'Places max'])}}
                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('places_free','Places free',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('places_free','',['class'=>'form-control col-sm-9','placeholder'=>'Places free'])}}
                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('airport','Airport',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('airport','',['class'=>'form-control col-sm-9','placeholder'=>'Airport'])}}
                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('images','Images',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('image1','',['class'=>'form-control col-sm-9','placeholder'=>'Image 1'])}}
                        {{Form::label('','',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('image2','',['class'=>'form-control col-sm-9','placeholder'=>'Image 2'])}}
                        {{Form::label('','',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('image3','',['class'=>'form-control col-sm-9','placeholder'=>'Image 3'])}}
                        {{Form::label('','',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('image4','',['class'=>'form-control col-sm-9','placeholder'=>'Image 4'])}}
                        {{Form::label('','',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('image5','',['class'=>'form-control col-sm-9','placeholder'=>'Image 5'])}}

                    </div>
                    <div class="form-group row mx-1">
                        {{Form::label('hotel_id','Hotel ID',['class'=>'col-sm-3 col-form-label'])}}
                        {{Form::text('hotel_id','',['class'=>'form-control col-sm-9','placeholder'=>'Hotel ID'])}}
                    </div>
